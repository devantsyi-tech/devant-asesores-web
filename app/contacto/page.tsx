  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        setStatusMessage(data.message || "Tu mensaje ha sido enviado correctamente, nos pondremos en contacto contigo pronto.")
        setFormData({
          name: "",
          email: "",
          phone: "",
        ...
        setStatusMessage(data.error || "Hubo un problema al enviar tu mensaje, por favor inténtalo de nuevo más tarde.")
      }
    } catch {
      setSubmitStatus("error")
      setStatusMessage("Hubo un problema al enviar tu mensaje, por favor inténtalo de nuevo más tarde.")
    } finally {
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              ¿Tienes dudas sobre qué seguro necesitas? Contacta con nosotros y 
              resolveremos todas tus preguntas personalmente. Asesoramiento gratuito 
              y sin compromiso.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <a href="tel:622233539" className="text-gray-600 text-sm hover:text-red-600 transition-colors">
                622 233 539
              </a>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 text-center hover:shadow-lg transition-shadow">
              ...
              <a href="mailto:info@devantasesores.com" className="text-gray-600 text-sm hover:text-red-600 transition-colors">
                info@devantasesores.com
              </a>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-8">
                ...
                posible. También puedes escribirnos directamente por WhatsApp o 
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Llámanos</h4>
                    <p className="text-gray-600 text-sm">
                      Atención telefónica de lunes a viernes
                    </p>
                    <a href="tel:622233539" className="text-red-600 font-medium">
                      622 233 539
                    </a>
                  </div>
                </div>
              ...
              {submitStatus === "success" ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    ...
                    className="w-full py-4 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
