...
const navigation = [
  ...
  { 
    ...
    href: "/seguros",
    children: [
      { name: "Automoviles", href: "/seguros/automoviles" },
      { name: "Vida", href: "/seguros/vida" },
      { name: "Patinete", href: "/seguros/patinete" },
      { name: "Decesos", href: "/seguros/decesos" },
      { name: "Negocios", href: "/seguros/negocios" },
      { name: "Mascotas", href: "/seguros/mascotas" },
      { name: "Ahorro", href: "/seguros/ahorro" },
      { name: "Viajes", href: "/seguros/viajes" },
      { name: "Hogar", href: "/seguros/hogar" },
      { name: "Comunidades", href: "/seguros/comunidades" },
  ...
  { 
    ...
    children: [
      ...
      { name: "Gestoria", href: "/servicios/gestoria" },
    ]
  },
...
export function Header() {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-gray-100 border-b border-gray-200">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-end h-8 gap-4">
            <a
              href="https://www.instagram.com/devantasesores/?hl=es"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/company/devantasesores/?viewAsMember=true"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-600 hover:text-red-600 transition-colors"
              aria-label="LinkedIn"
      ...
      <header
        className={cn(
          "fixed top-8 left-0 right-0 z-50 transition-all duration-300 bg-white",
                  ...
                  {item.children ? (
                    ...
                    >
                      ...
                      <ChevronDown className={cn(
                        "h-4 w-4 text-gray-800 transition-transform",
            ...
            <nav className="lg:hidden mt-4 pb-4 border-t border-gray-200 pt-4">
              {navigation.map((item) => (
                <div key={item.name}>
                  <Link
                    href={item.href}
                    className="block py-2 text-gray-800 font-medium hover:text-red-600 transition-colors"
